    ...
    Id: Eq + Hash + Clone + Debug + Display,
{
    ...
    pub(crate) fn refresh_pressure_mode(&mut self, incoming_items: usize) -> bool {
    ...
    pub(crate) fn pop_next(&mut self) -> Option<PopItem<Id, T>> {
        loop {
            ...
            let _ = self.refresh_pressure_mode(0);
    ...
    fn effective_per_id_limit(
        ...
        let pressure_enforced = self.refresh_pressure_mode(incoming_items);
