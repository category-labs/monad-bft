...
use alloy_primitives::{keccak256, Address, PrimitiveSignature, TxKind, FixedBytes, B256, U256};
...
impl Faucet {
    pub fn new() -> Self {
        Self::new_with_pk(B256::from_str("0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80").unwrap())
    }
    ...
    pub fn fund(
        ...
        let tx_receiver_address = PrivateKeySigner::from_bytes(&tx_receiver).unwrap().address();
    ...
    pub fn fund_address(
        ...
        let tx_signature = self.priv_key
