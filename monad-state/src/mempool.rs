...
pub(super) struct MempoolChildState<'a, CP, ST, SCT, VT, LT, TT, ASVT> {
    txpool: &'a mut TT,

    _phantom: PhantomData<(CP, ST, SCT, VT, LT, ASVT)>,
}

pub(super) struct MempoolCommand {}

impl<'a, CP, ST, SCT, VT, LT, TT, ASVT> MempoolChildState<'a, CP, ST, SCT, VT, LT, TT, ASVT>
where
    ...
    TT: TxPool,
{
    pub(super) fn new(monad_state: &'a mut MonadState<CP, ST, SCT, VT, LT, TT, ASVT>) -> Self {
        Self {
