...
pub(super) struct EpochChildState<'a, ST, SCT, VTF, LT, TPT, SVT, ASVT>
where
    ...
    VTF: ValidatorSetTypeFactory<NodeIdPubKey = CertificateSignaturePubKey<ST>>,
{
    ...
    _phantom: PhantomData<(ST, LT, TPT, SVT, ASVT)>,
}

pub(super) struct EpochCommand {}

impl<'a, ST, SCT, VTF, LT, TPT, SVT, ASVT> EpochChildState<'a, ST, SCT, VTF, LT, TPT, SVT, ASVT>
where
    ST: CertificateSignatureRecoverable,
    SCT: SignatureCollection<NodeIdPubKey = CertificateSignaturePubKey<ST>>,
    VTF: ValidatorSetTypeFactory<NodeIdPubKey = CertificateSignaturePubKey<ST>>,
