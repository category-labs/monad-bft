...
define_metrics! {
    ...
    udp_pacing_command_channel_drops => UDP_PACING_COMMAND_CHANNEL_DROPS("monad.dataplane.udp.pacing.total_command_channel_drops", "Total UDP egress messages rejected by the pacing command channel"),
    ...
    udp_pacing_memory_limit_bytes => UDP_PACING_MEMORY_LIMIT_BYTES("monad.dataplane.udp.pacing.memory_limit_bytes", "Configured payload byte limit for each pacing traffic class"),
    udp_tx_queue_wait_micros => UDP_TX_QUEUE_WAIT_MICROS("monad.dataplane.udp.tx_queue.total_wait_micros", "Total time in microseconds the pacing task waited for space in the UDP transmit queue"),
    egress_pacing_bandwidth_limit_bytes_per_second => EGRESS_PACING_BANDWIDTH_LIMIT_BYTES_PER_SECOND("monad.dataplane.egress.pacing.bandwidth_limit_bytes_per_second", "Configured shared dataplane egress pacing limit in bytes per second"),
    egress_pacing_high_queued_requests => EGRESS_PACING_HIGH_QUEUED_REQUESTS("monad.dataplane.egress.pacing.high.current_queued_requests", "Current queued high-priority shared egress pacing requests"),
    egress_pacing_high_grants => EGRESS_PACING_HIGH_GRANTS("monad.dataplane.egress.pacing.high.total_grants", "Total high-priority shared egress pacing grants"),
    egress_pacing_high_granted_bytes => EGRESS_PACING_HIGH_GRANTED_BYTES("monad.dataplane.egress.pacing.high.total_granted_bytes", "Total bytes admitted by high-priority shared egress pacing grants"),
    egress_pacing_high_wait_micros => EGRESS_PACING_HIGH_WAIT_MICROS("monad.dataplane.egress.pacing.high.total_wait_micros", "Total time in microseconds spent waiting for high-priority shared egress pacing grants"),
    egress_pacing_regular_queued_requests => EGRESS_PACING_REGULAR_QUEUED_REQUESTS("monad.dataplane.egress.pacing.regular.current_queued_requests", "Current queued regular-priority shared egress pacing requests"),
    egress_pacing_regular_grants => EGRESS_PACING_REGULAR_GRANTS("monad.dataplane.egress.pacing.regular.total_grants", "Total regular-priority shared egress pacing grants"),
    egress_pacing_regular_granted_bytes => EGRESS_PACING_REGULAR_GRANTED_BYTES("monad.dataplane.egress.pacing.regular.total_granted_bytes", "Total bytes admitted by regular-priority shared egress pacing grants"),
    egress_pacing_regular_wait_micros => EGRESS_PACING_REGULAR_WAIT_MICROS("monad.dataplane.egress.pacing.regular.total_wait_micros", "Total time in microseconds spent waiting for regular-priority shared egress pacing grants"),
    egress_pacing_background_queued_requests => EGRESS_PACING_BACKGROUND_QUEUED_REQUESTS("monad.dataplane.egress.pacing.background.current_queued_requests", "Current queued background shared egress pacing requests"),
    egress_pacing_background_grants => EGRESS_PACING_BACKGROUND_GRANTS("monad.dataplane.egress.pacing.background.total_grants", "Total background shared egress pacing grants"),
    egress_pacing_background_granted_bytes => EGRESS_PACING_BACKGROUND_GRANTED_BYTES("monad.dataplane.egress.pacing.background.total_granted_bytes", "Total bytes admitted by background shared egress pacing grants"),
    egress_pacing_background_wait_micros => EGRESS_PACING_BACKGROUND_WAIT_MICROS("monad.dataplane.egress.pacing.background.total_wait_micros", "Total time in microseconds spent waiting for background shared egress pacing grants"),
