...
define_metrics! {
    ...
    udp_tx_worker_channel_messages_dropped => UDP_TX_WORKER_CHANNEL_MESSAGES_DROPPED("monad.dataplane.udp.tx_worker_channel.total_messages_dropped", "Total UDP messages dropped because a transmit worker channel was full"),
    udp_tx_worker_channel_bytes_dropped => UDP_TX_WORKER_CHANNEL_BYTES_DROPPED("monad.dataplane.udp.tx_worker_channel.total_bytes_dropped", "Total UDP payload bytes dropped because a transmit worker channel was full"),
