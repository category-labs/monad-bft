...
fn udp_broadcast() {
    ...
    let mut rx = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_udp_sockets([(UdpSocketId::Raptorcast, rx_addr)])
        .build();
    let mut tx = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_udp_sockets([(UdpSocketId::Raptorcast, tx_addr)])
        .build();
...
fn udp_direct_socket() {
    ...
    let mut rx = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_udp_sockets([
            (UdpSocketId::Raptorcast, rx_addr),
            (UdpSocketId::AuthenticatedRaptorcast, rx_direct_addr),
        ])
        .build();
    let mut tx = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_udp_sockets([
            (UdpSocketId::Raptorcast, tx_addr),
            (UdpSocketId::AuthenticatedRaptorcast, tx_direct_addr),
        ])
        .build();
...
fn tcp_very_slow() {
    ...
    let mut rx = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_tcp_sockets([(TcpSocketId::Raptorcast, rx_addr)])
        .build();
    let mut tx = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_tcp_sockets([(TcpSocketId::Raptorcast, tx_addr)])
        .build();
...
async fn test_tcp_limits_are_applied(
    ...
    let mut tx1 = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_tcp_sockets([(TcpSocketId::Raptorcast, tx1_addr)])
        .build();
    let mut tx2 = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_tcp_sockets([(TcpSocketId::Raptorcast, tx2_addr)])
        .build();
...
fn tcp_multi_socket() {
    ...
    let mut rx = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_tcp_sockets([
            (TcpSocketId::Raptorcast, rx_addr),
            (TcpSocketId::AuthenticatedRaptorcast, rx_addr_2),
        ])
        .build();
    let mut tx = DataplaneBuilder::new(UP_BANDWIDTH_MBPS)
        .with_tcp_sockets([
            (TcpSocketId::Raptorcast, tx_addr),
            (TcpSocketId::AuthenticatedRaptorcast, tx_addr_2),
        ])
        .build();
