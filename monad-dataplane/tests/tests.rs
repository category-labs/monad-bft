...
fn udp_priority_delivery() {
    ...
    let rx_addr = "127.0.0.1:9023".parse().unwrap();
    let tx_addr = "127.0.0.1:9024".parse().unwrap();
...
fn udp_priority_with_regular_then_high_traffic() {
    ...
    let rx_addr = "127.0.0.1:9025".parse().unwrap();
    let tx_addr = "127.0.0.1:9026".parse().unwrap();
    let low_bandwidth_mbps = 10;
