...
impl TriedbHandle {
    ...
    pub fn read_valset_at_block(
        ...
        let validator_set_result = unsafe {
        ...
        let read_result = validator_set_result.result;
        assert_eq!(read_result, 0);

        let val_set_ptr = validator_set_result.validator_set.validators;
        let val_set_length: usize = validator_set_result
            .validator_set
            .length
            .try_into()
        ...
        unsafe { bindings::free_valset(validator_set_result.validator_set) };
