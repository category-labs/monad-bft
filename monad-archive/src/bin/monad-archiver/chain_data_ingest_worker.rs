...
use monad_chain_data::{
    compute_trace_addresses, run_configured_chain_data_ingest, CallKind, ChainDataIngestSource,
    FinalizedBlock, IngestTrace, IngestTx,
};
use tracing::warn;
...
pub async fn chain_data_ingest_worker(
    ...
    run_configured_chain_data_ingest(
        config.store,
        config.runner,
