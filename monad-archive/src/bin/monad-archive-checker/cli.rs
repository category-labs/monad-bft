...
pub struct Rechecker {
    ...
    /// Use rechecker v1 (legacy mode that only rechecks individual faulty blocks).
    /// Rechecker v2 is recommended as it rechecks entire chunks from scratch.
    #[arg(long)]
    pub use_rechecker_v1: bool,
