...
impl Triedb for TriedbEnv {
        ...
        match request_receiver.await {
            ...
            Err(e) => {
                ...
                Err(ArchiveError::custom_error(
                    "get_latest_block: channel closed".to_string(),
                ))
            }
        }
    }
    ...
    async fn get_receipts(&self, block_num: u64) -> Result<Vec<ReceiptWithBloom>, ArchiveError> {
            ...
            }))
        {
            error!("Polling thread channel full: {e}");
            return Err(ArchiveError::custom_error(
                "get_receipts: Polling thread channel full, unable to service request".into(),
            ));
        }
        ...
        match request_receiver.await {
            ...
            Err(e) => {
                ...
                Err(ArchiveError::custom_error(
                    "get_receipt: channel closed".into(),
                ))
            }
        }
    }
    ...
    async fn get_transactions(
            ...
            }))
        {
            error!("Polling thread channel full: {e}");
            return Err(ArchiveError::custom_error(
                "get_transactions: Polling thread channel full, unable to service request".into(),
            ));
        }
        ...
        match request_receiver.await {
            ...
            Err(e) => {
                error!("Error awaiting result: {e}");
                Err(ArchiveError::custom_error(
                    "get_transactions: channel closed".into(),
                ))
            }
        }
    }
    ...
    async fn get_block_header(&self, block_num: u64) -> Result<Option<BlockHeader>, ArchiveError> {
            ...
            }))
        {
            error!("Polling thread channel full: {e}");
            return Err(ArchiveError::custom_error(
                "get_block_header: Polling thread channel full, unable to service request".into(),
            ));
        }
        ...
        match request_receiver.await {
            ...
            Err(e) => {
                error!("Error awaiting result: {e}");
                Err(ArchiveError::custom_error(
                    "get_block_header: channel closed".into(),
                ))
            }
        }
    }
    ...
    async fn get_call_frames(&self, block_num: u64) -> Result<Vec<Vec<u8>>, ArchiveError> {
            ...
            }))
        {
            error!("Polling thread channel full: {e}");
            return Err(ArchiveError::custom_error(
                "get_call_frames: Polling thread channel full, unable to service request".into(),
            ));
        }
        ...
        match request_receiver.await {
            ...
            Err(e) => {
                error!("Error awaiting result: {e}");
                Err(ArchiveError::custom_error(
                    "get_call_frames: channel closed".into(),
                ))
            }
        }
    }
