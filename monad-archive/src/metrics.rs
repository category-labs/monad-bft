...
pub enum MetricNames {
    ...
    WORKER_RESTARTS,
    WORKER_LAST_SUCCESS_UNIX_S,
    WORKER_STALLED_SECONDS,

    SOURCE_LATEST_BLOCK_NUM,
    END_BLOCK_NUMBER,
    START_BLOCK_NUMBER,

    BFT_LATEST_UPLOADED_SEQ,
    BFT_BLOCKS_UPLOADED,
...
impl MetricNames {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            MetricNames::WORKER_HEALTH_STATUS => "worker_health_status",
            MetricNames::WORKER_RETRY_ATTEMPTS => "worker_retry_attempts",
            MetricNames::WORKER_RESTARTS => "worker_restarts",
            MetricNames::WORKER_LAST_SUCCESS_UNIX_S => "worker_last_success_unix_s",
            MetricNames::WORKER_STALLED_SECONDS => "worker_stalled_seconds",
            ...
            MetricNames::BFT_LATEST_UPLOADED_SEQ => "bft_latest_uploaded_seq",
