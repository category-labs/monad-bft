...
version = "0.5.0"
source = "registry+https://github.com/rust-lang/crates.io-index"
checksum = "305080716a198f6a57096263ac2df9f681f9487728819a83e0137b18050fc8ad"
dependencies = [
 "cc",
 "softaes",
]
...
name = "agent"
version = "0.1.1"
source = "git+https://github.com/category-labs/manytrace.git?tag=v0.1.1#1598f5c4fb725b54c83c224c1d58c27dcda9b61f"
dependencies = [
 "arc-swap",
 "libc",
 "mpscbuf",
...
[[package]]
name = "monad-eth-block-validator"
version = "0.1.0"
dependencies = [
 "alloy-consensus",
 "alloy-eips",
...
[[package]]
name = "monad-eth-txpool-executor"
version = "0.1.0"
dependencies = [
 "alloy-consensus",
 "alloy-eips",
...
dependencies = [
 ...
 "monad-state",
 "monad-state-backend",
 "monad-state-backend-cache",
 "monad-statesync-executor",
 "monad-triedb-utils",
 "monad-types",
 "monad-updaters",
 "monad-validator",
...
[[package]]
name = "monad-state-backend-cache"
version = "0.1.0"
dependencies = [
 "alloy-primitives",
 "itertools 0.13.0",
