    ...
    SVT: StateRootValidator,
{
    ...
    fn new(
        ...
        ConsensusState {
            ...
            // Q: is delta * 4 a good duration? need to check what is a good value for constant
            block_sync_manager: BlockSyncManager::new(NodeId(my_pubkey), delta * 4),
            keypair,
            cert_keypair,
        }
    }
...
mod test {
    ...
    fn test_observe_qc_through_tmo() {
        ...
        // now timeout someone
        let cmds = states[1].handle_timeout_expiry::<Sha256Hash>();
