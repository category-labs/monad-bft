...
use monad_consensus_types::{
    block_validator::MockValidator, payload::StateRoot, state_root_hash::StateRootHash,
...
async fn run(node_state: NodeState) -> Result<(), ()> {
    ...
    if node_state
        ...
        .map_or(false, |v| v)
    {
        info!("Running with byzantine state root executor");
        executor
            .state_root_hash
    ...
    let builder = MonadStateBuilder {
        ...
        state_root_validator: StateRoot::new(SeqNum(4)),
