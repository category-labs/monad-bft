...
defaults: `high_watermark_sessions`=100,000, `handshake_cookie_unverified_rate_limit`=1000/sec, `handshake_cookie_verified_rate_limit`=1000/sec, `low_watermark_sessions`=10,000, `ip_rate_limit_window`=10s, `max_sessions_per_ip`=10, `ip_history_capacity`=1,000,000
