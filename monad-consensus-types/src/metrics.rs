...
metrics!(
    (NodeState, node_state, [(self_stake_bps, "Self stake in basis points")]),
    (
        ValidationErrors,
        validation_errors,
        [
            (invalid_author, "Validation errors - invalid author"),
            (not_well_formed_sig, "Validation errors - malformed signature"),
            (invalid_signature, "Validation errors - invalid signature"),
            (invalid_tc_round, "Validation errors - invalid TC round"),
            (duplicate_tc_tip_round, "Validation errors - duplicate TC tip round"),
            (empty_signers_tc_tip_round, "Validation errors - empty signers TC tip"),
            (too_many_tc_tip_round, "Validation errors - too many TC tip round"),
            (insufficient_stake, "Validation errors - insufficient stake"),
            (invalid_seq_num, "Validation errors - invalid sequence number"),
            (val_data_unavailable, "Validation errors - validator data unavailable"),
            (signatures_duplicate_node, "Validation errors - duplicate node signatures"),
            (invalid_vote_message, "Validation errors - invalid vote message"),
    ...
    (
        ...
        [
            ...
            (invalid_proposal_round_leader, "Invalid proposal round leader"),
            ...
            (remote_timeout_msg_with_tc, "Remote timeout messages with TC"),
            (remote_timeout_msg_with_future_tc, "Remote timeout messages with future TC"),
            ...
            (failed_verify_randao_reveal_sig, "Failed RANDAO reveal signature verifications"),
            ...
            (invalid_round_recovery_leader, "Invalid round recovery leader"),
            (handle_no_endorsement, "No endorsement handling events"),
            (old_no_endorsement_received, "Old no endorsement messages received"),
            (future_no_endorsement_received, "Future no endorsement messages received"),
    ...
    (
        ...
        [
            ...
            (self_payload_requests_in_flight, "Self payload requests in flight"),
            ...
            (self_headers_response_successful, "Successful self headers responses"),
            (self_headers_response_failed, "Failed self headers responses"),
            ...
            (self_payload_response_successful, "Successful self payload responses"),
            (self_payload_response_failed, "Failed self payload responses"),
            (request_timeout, "Block sync request timeouts"),
            (request_failed_no_peers, "Block sync requests failed - no peers"),
            (peer_headers_request, "Peer headers requests"),
            (peer_headers_request_successful, "Successful peer headers requests"),
            (peer_headers_request_failed, "Failed peer headers requests"),
            (peer_payload_request, "Peer payload requests"),
            (peer_payload_request_successful, "Successful peer payload requests"),
