    ...
    ST: CertificateSignatureRecoverable,
{
    ...
    pub raptor10_redundancy: f64, // TODO: rename raptor10_redundancy_validators to match node-config
}
    ...
    ST: CertificateSignatureRecoverable,
{
    fn default() -> RaptorCastConfigPrimary<ST> {
        RaptorCastConfigPrimary {
            ...
            raptor10_redundancy: 3.0, // for validators
        }
    }
}
    ...
    ST: CertificateSignatureRecoverable,
{
    ...
    pub raptor10_redundancy: f64, // TODO: rename raptor10_redundancy_fullnodes to match node-config
}
    ...
    ST: CertificateSignatureRecoverable,
{
    fn default() -> RaptorCastConfigSecondaryPublisher<ST> {
        RaptorCastConfigSecondaryPublisher {
            ...
            raptor10_redundancy: 2.0, // for full-nodes
        }
    }
}
