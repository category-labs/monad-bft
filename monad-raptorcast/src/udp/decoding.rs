...
type ActorScopedDecoderStateCache<PT> = LruCache<NodeId<PT>, DecoderStateCache>;
    ...
    PT: PubKey,
{
    ...
    broadcast: ActorScopedDecoderStateCache<PT>,
    validator: ActorScopedDecoderStateCache<PT>,
    p2p: ActorScopedDecoderStateCache<PT>,
}
    ...
    PT: PubKey,
{
    ...
    fn get_author_slot(
        ...
        message: &ValidatedMessage<PT>,
        validator_set: Option<&ValidatorSet<PT>>,
    ) -> &mut ActorScopedDecoderStateCache<PT> {
