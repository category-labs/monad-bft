    ...
    MP: MetricsPolicy,
{
    ...
    waker: Option<Waker>,
    metrics: RaptorCastExecutorMetrics<MP>,
...
where
    ...
    MP: MetricsPolicy,
{
    pub fn new(config: RaptorCastConfig<ST>, metrics: RaptorCastExecutorMetrics<MP>) -> Self {
    ...
    MP: MetricsPolicy,
{
    ...
    type Metrics = RaptorCastExecutorMetrics<MP>;
