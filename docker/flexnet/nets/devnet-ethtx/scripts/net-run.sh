...
# Config
docker run --rm -v $flexnet_root:/monad monad-python-dev:latest bash -c "cd /monad/$(realpath -s --relative-to=$flexnet_root $vol_root) && python3 /monad/common/config-gen.py -c 8 -s ''"
# tc.sh
...
# verify ledger
# docker run --rm -v ./$vol_root:/monad monad-python bash -c "python3 /monad/scripts/verify-ledger.py -c 7 -l ledger -n $(( 600 * 10 - 500 ))"
docker run --rm -v ./$vol_root:/monad monad-python bash -c "python3 /monad/scripts/verify-ledger.py -c 8 -l ledger -n $(( 10 ))"
...
docker run --rm -v $flexnet_root:/monad monad-python bash -c "python3 /monad/common/count-tx.py --min $(( 6000  )) --ledger $vol_root/node0/ledger"
