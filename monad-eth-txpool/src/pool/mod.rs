...
use self::{tracked::TrackedTxMap, transaction::ValidEthTransaction};
    ...
    CertificateSignaturePubKey<ST>: ExtractEthAddress,
{
    ...
    pub fn insert_txs(
        ...
        for (address, txs) in txs {
            ...
            self.tracked
                .try_insert_txs(event_tracker, address, txs, account_nonce, &mut on_insert);
        }
    ...
    pub fn update_committed_block(
        ...
        self.tracked
            .update_committed_block(event_tracker, committed_block);
