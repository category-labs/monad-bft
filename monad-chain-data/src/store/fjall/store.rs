...
// gets its own physical fjall keyspace, prefixed by the kind so logical
// surfaces never share storage even if their logical names collide.
...
/// Embedded fjall-backed implementation of [`MetaStore`] and [`BlobStore`].
///
