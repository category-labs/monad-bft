...
use monad_chain_data::{compute_trace_addresses, Family, PrimaryId, B256};

mod common;

use common::{
    block_with_traces, block_with_txs, chain_header, load_record, nested_call, test_header,
    top_level_call,
};
...
async fn ingest_persists_trace_artifacts_for_block_with_traces() {
    ...
    let store = common::populate::populate_via_engine(vec![block_with_traces(
