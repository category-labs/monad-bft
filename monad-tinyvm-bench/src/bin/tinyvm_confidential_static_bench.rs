...
use monad_chain_config::{
    ChainConfig, execution_revision::MonadExecutionRevision, revision::MockChainRevision,
    MockChainConfig,
};
use monad_eth_block_policy::validation::static_validate_transaction;
    ...
    for iter in 0..iterations {
        ...
        for tx in &txs {
            static_validate_transaction(
                ...
                MonadExecutionRevision::V_TINYVM.execution_chain_params(),
            )
            .unwrap();
        }
